...
const leftButton = document.querySelector('[data-direction="left"]');
const rightButton = document.querySelector('[data-direction="right"]');
const downButton = document.querySelector('[data-direction="down"]');
